...
public class MossySheepWoolFeature<T extends Sheep, F extends SheepModel<T>>
    ...
    public void render(PoseStack matrixStack, MultiBufferSource vertexConsumerProvider, int i, T sheepEntity, float f, float g, float h, float j, float k, float l) {
        ...
        if (name.equals("DEFAULT")) {
            skin = new ResourceLocation("textures/entity/sheep_fur.png");
        } else {
            skin = new ResourceLocation(WilderNature.MOD_ID, "textures/entity/" + name + "_sheep_fur.png");
        }
        ...
        MossySheepWoolFeature.coloredCutoutModelCopyLayerRender(this.getParentModel(), this.model, skin, matrixStack, vertexConsumerProvider, i, sheepEntity, f, g, j, k, l, h, s, t, u);
    }
}