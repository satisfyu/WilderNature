...
public class HedgehogModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition torso = root.addOrReplaceChild("torso", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -3.984F, -3.9564F, 6.0F, 5.0F, 8.0F, new CubeDeformation(0.0F))
